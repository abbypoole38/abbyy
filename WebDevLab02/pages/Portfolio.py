...
def experience_section(experience_data):
    st.header("🛠️ Professional Experience")
...
def project_section(projects_data):
    ...
    # Adding the movie app description
    st.subheader("My Favorite Movies App")
    movie_app_description = (
        "This app allows users to browse and filter movies based on genres, view descriptions, and visualize movie ratings dynamically. "
        "It features genre filtering, interactive movie selection, and data visualization through dynamic and static bar charts. "
        "The app uses Streamlit's Session State to maintain user selections without refreshing the page, ensuring a seamless user experience."
    )

    expander = st.expander("My Favorite Movies App")
    expander.write(movie_app_description)
